...
### Fixed
- **Runware dimension normalization:** Step size changed from 64 to 8 to support models like Nano Banana 2 with non-64-step dimensions (e.g., 896×1200). Dimensions now round to nearest multiple of 8 instead of 64.

### Changed
- **Dependencies:** Updated uuid (9.0.1→14.0.0), ip-address (10.1.0→10.2.0), axios (1.15.0→1.15.2), and website postcss/babel audit fixes.
